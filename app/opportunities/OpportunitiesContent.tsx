...
import { OpportunityCategory, CATEGORIES } from '@/lib/opportunities';
...
export function OpportunitiesContent() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-foreground mb-1">All Opportunities</h1>
        <p className="text-muted-foreground text-sm">
          Browse and filter through all available student opportunities
        </p>
      </div>
