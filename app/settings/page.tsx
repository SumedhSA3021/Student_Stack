...
function CategorySelection() {
  ...
  return (
    <div className="rounded-xl border border-zinc-800/80 bg-zinc-900/40 backdrop-blur-sm p-4">
      <p className="text-xs text-zinc-500 mb-3">Select categories you want to prioritize</p>
            ...
            <button
              ...
              className={cn(
                ...
                isSelected
                  ...
                  : 'bg-zinc-800/50 border border-zinc-700/50 text-zinc-400 hover:text-zinc-300'
              )}
            >
